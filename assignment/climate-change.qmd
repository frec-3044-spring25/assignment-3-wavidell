...
Each column is a number, with the 'no_smoothing' and 'lowess(5)' columns being measured in degrees Celsius.  
Global temperature refers to the average global temperature, while global temperature anomoly refers to how many degrees off of the average we are at for a given year.
...
```
Generally, the anomaly fluctuates, but there is an overall upward trend. Around 1980, the anomaly begins to climb.
